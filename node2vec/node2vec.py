...
class Node2Vec:
    ...
    def __init__(self,e_nodes, graph: nx.Graph, dimensions: int = 128, walk_length: int = 80, num_walks: int = 10, p: float = 2,
        ...
        for source in nodes_generator:
            ...
            for current_node in self.graph.neighbors(source):
                ...
                for destination in self.graph.neighbors(current_node):
                    ...
                    elif destination in self.e_nodes:  # If the neighbor is connected to the source
